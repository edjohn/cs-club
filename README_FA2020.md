...
1. Get ready for our first Coding Competition! We will be using https://binarysearch.com/, so go ahead and make an account for the site.
...
3. The optional coding challenge for the week is particularly challenging-- it requires knowledge of pointers and linked lists! Try this if the past challenges were too easy for you. Our coding challenges will be comparable in difficulty to the coding challenges from previous weeks, but this challenge is good practice for coding interviews.
...
### Note on Week 7:
This meeting was a guest lecture held on Zoom.